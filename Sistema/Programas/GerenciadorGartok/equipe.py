...
class Equipe:
    ...
    def cria_planilha(self):
        self.planilha_equipe = pd.DataFrame(columns=['Nome','CA','HP','Mod_Força','Mod_Destreza','Mod_Constituição',
        ...
        for personagem in self.personagens:
            ...
            'Mod_Força':personagem.mod_força,
    ...
    def exporta_planilha(self):
        self.planilha_equipe.to_excel('Equipe.xlsx',encoding='utf-8')
